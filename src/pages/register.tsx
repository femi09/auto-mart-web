...
const navigate: NavigateFunction = useNavigate();
  ...
  return (
    <div className="grid place-items-center sm:w-2/3 xl:w-1/2 bg-gray-100 bg-opacity-50 text-green-900 rounded-lg py-20 my-20 sm:mx-auto">
      <form onSubmit={formik.handleSubmit} className="px-4 sm:px-0 sm:w-2/3" action="">
        <div className="flex">
          <div className="w-1/2">
            <InputField
              name="firstname"
        ...
        <div className="my-4 flex w-full">
          <button type="submit" className="px-4 py-2 rounded-lg bg-green-900 text-white font-bold w-1/3 xl:w-1/4 my-4 mx-auto">
            Sign up
          </button>
        </div>
